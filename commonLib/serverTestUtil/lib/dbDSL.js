...
let init = function (numberOfUser, isElyoosAdmin) {
    ...
    return db.clearDatabase().then(function () {
        ...
        for (i = 0; i < numberOfUser - 1; i++) {
            ...
            language: 'de', emailNormalized: 'user${userId}@irgendwo.ch', latitude: 0, longitude: 0})`).end().getCommand());
        }
    });
};
...
module.exports = {
    ...
    upVoteTextAnswer: answer.upVoteTextAnswer,
    upVoteYoutubeAnswer: answer.upVoteYoutubeAnswer,
