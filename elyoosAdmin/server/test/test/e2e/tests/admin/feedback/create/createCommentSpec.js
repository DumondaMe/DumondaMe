...
describe('Integration Tests creating comments for feedback elements', function () {
    ...
    it('Create comment for bug', function () {
        ...
        return dbDsl.sendToDb().then(function () {
            ...
            return requestHandler.post('/api/admin/feedback/create/comment', {feedbackId: '1', text: 'text'});
        }).then(function (res) {
    ...
    it('Create comment for idea', function () {
        ...
        return dbDsl.sendToDb().then(function () {
            ...
            return requestHandler.post('/api/admin/feedback/create/comment', {feedbackId: '3', text: 'text'});
        }).then(function (res) {
            res.status.should.equal(200);
            res.body.created.should.be.at.least(startTime);
            res.body.creator.name.should.equals('user Meier');
    ...
    it('Create comment for discussion idea', function () {
        ...
        return dbDsl.sendToDb().then(function () {
            ...
            return requestHandler.post('/api/admin/feedback/create/comment', {feedbackId: '7', text: 'text'});
        }).then(function (res) {
            res.status.should.equal(200);
            res.body.created.should.be.at.least(startTime);
            res.body.creator.name.should.equals('user Meier');
    ...
    it('Create comment for discussion (not allowed 400)', function () {
        ...
        return dbDsl.sendToDb().then(function () {
            ...
            return requestHandler.post('/api/admin/feedback/create/comment', {feedbackId: '5', text: 'text'});
        }).then(function (res) {
    ...
    it('Create comment for not existing bug (400)', function () {
        ...
        return dbDsl.sendToDb().then(function () {
            ...
            return requestHandler.post('/api/admin/feedback/create/comment', {feedbackId: '8', text: 'text'});
        }).then(function (res) {
            res.status.should.equal(400);
        });
    });
