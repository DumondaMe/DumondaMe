...
var testee = require('../../../../../../models/eMailService/processingJobs');
var email = require('../../../../../../lib/eMail/eMail');
var db = require('../../../../e2e/tests/util/db');
var sinon = require('sinon');
var expect = require('chai').expect;

describe('Unit Test eMailService/processingJobs', function () {
    ...
    it('Send a Email to the user who received a message', function () {
        ...
        return db.cypher().create("(:EMailNotification {userId: '1', lastJobId: '2', lastUpdated: 500, countUpdates: 0})")
            .end().send(commands).then(function () {
                return testee.emailReceived({userId: '1', jobId: '2'}, finished).then(function () {
                    expect(sendEMail.withArgs('newMessages', {numberOfUnreadMessages: 3}, 'test@gmx.ch').calledOnce).to.be.true;
