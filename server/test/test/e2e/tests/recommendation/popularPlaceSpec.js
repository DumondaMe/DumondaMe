...
describe('Integration Tests for getting popular place recommendations', function () {
    ...
    it('Getting most popular place recommendations for a area - Return 200', function () {
        ...
        dbDsl.createPlacePage('1', '1', ['de'], ['health', 'personalDevelopment'], 5072, 'Test1', [{description: 'Zuerich', lat: 47.376887, lng: 8.541694}, {
            description: 'Zuerich Paradeplatz',
            lat: 47.369890,
            lng: 8.539127
        }]);
        dbDsl.createPlacePage('2', '1', ['de'], ['health', 'personalDevelopment'], 5073, 'Test2', [{description: 'Urdorf', lat: 47.386707, lng: 8.420693}]);
        dbDsl.createPlacePage('3', '1', ['de'], ['health', 'personalDevelopment'], 5074, 'Test3', [{description: 'Altstetten', lat: 47.388237, lng: 8.483051}]);
        dbDsl.createPlacePage('4', '1', ['de'], ['health', 'personalDevelopment'], 5075, 'Test4', [{description: 'Bern', lat: 46.947974, lng: 7.447447}]);
        dbDsl.createPlacePage('5', '1', ['de'], ['health', 'personalDevelopment'], 5076, 'Test5', [{description: 'Genf', lat: 46.204391, lng: 6.143158}]);
