...
describe('Integration Tests for getting popular recommendations', function () {
    ...
    it('Getting most popular recommendations ever - Return 200', function () {
        ...
        dbDsl.createBlog('1', ['en'], ['health'], 5077, null, 250);
        dbDsl.createBlog('2', ['en'], ['spiritual'], 5077, null, null);
        ...
        return dbDsl.sendToDb().then(function () {
            return requestHandler.login(users.validUser).then(function (agent) {
                ...
                res.body.recommendations[0].description.should.equals('page4Description');
                res.body.recommendations[0].link.should.equals('www.link.com/link');
                res.body.recommendations[0].numberOfRecommendations.should.equals(4);
                res.body.recommendations[0].language.length.should.equals(1);
                res.body.recommendations[0].language[0].should.equals('fr');
                ...
                res.body.recommendations[1].text.should.equals('blog1Text');
                res.body.recommendations[1].heightPreviewImage.should.equals(250);
                res.body.recommendations[1].url.should.equals('blog/1/preview.jpg');
                res.body.recommendations[1].numberOfRecommendations.should.equals(3);
                res.body.recommendations[1].language.length.should.equals(1);
                res.body.recommendations[1].language[0].should.equals('en');
                ...
                res.body.recommendations[2].description.should.equals('page3Description');
                ...
                res.body.recommendations[2].language.length.should.equals(1);
                res.body.recommendations[2].language[0].should.equals('fr');
                ...
                res.body.recommendations[3].description.should.equals('page2Description');
                res.body.recommendations[3].numberOfRecommendations.should.equals(2);
                res.body.recommendations[3].language.length.should.equals(1);
                res.body.recommendations[3].language[0].should.equals('de');
