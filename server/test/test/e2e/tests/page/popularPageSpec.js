...
describe('Integration Tests for getting popular pages', function () {
    ...
    it('Getting only most popular books recommended by users contact - Return 200', function () {
        ...
        commands.push(db.cypher().create("(:Page {title: 'page3Title', label: 'Book', language: 'de', description: 'page3', modified: 5073, pageId: '2'})").end().getCommand());
        commands.push(db.cypher().create("(:Page {title: 'page4Title', label: 'Book', language: 'de', description: 'page4', modified: 5074, pageId: '3'})").end().getCommand());
        commands.push(db.cypher().create("(:Page {title: 'page5Title', label: 'Book', language: 'de', description: 'page5', modified: 5075, pageId: '4'})").end().getCommand());
        ...
        commands.push(db.cypher().match("(a:Page {pageId: '1'}), (b:User {userId: '4'})")
        ...
        commands.push(db.cypher().match("(a:Page {pageId: '3'}), (b:User {userId: '4'})")
            .create("(b)-[:RECOMMENDS]->(:Recommendation {created: 508, rating: 5, recommendationId: '8'})-[:RECOMMENDS]->(a)").end().getCommand());


        return db.cypher().create("(:Page {title: 'page2Title', label: 'Youtube', description: 'page2', modified: 5080, pageId: '1'})")
    ...
    it('Getting only most popular youtube videos recommended by users contact - Return 200', function () {
        ...
        commands.push(db.cypher().create("(:Page {title: 'page1Title', label: 'Youtube', link: 'www.link.com', language: 'de', description: 'page1', modified: 5072, pageId: '0'})").end().getCommand());
        commands.push(db.cypher().create("(:Page {title: 'page2Title', label: 'Youtube', link: 'www.link2.com', language: 'de', description: 'page2', modified: 5071, pageId: '1'})").end().getCommand());
        commands.push(db.cypher().create("(:Page {title: 'page3Title', label: 'Youtube', link: 'www.link3.com', language: 'de', description: 'page3', modified: 5073, pageId: '2'})").end().getCommand());
        commands.push(db.cypher().create("(:Page {title: 'page4Title', label: 'Youtube', language: 'de', description: 'page4', modified: 5074, pageId: '3'})").end().getCommand());
        commands.push(db.cypher().create("(:Page {title: 'page5Title', label: 'Youtube', language: 'de', description: 'page5', modified: 5075, pageId: '4'})").end().getCommand());
        ...
        commands.push(db.cypher().match("(a:Page {pageId: '2'}), (b:User {userId: '2'})")
            .create("(b)-[:RECOMMENDS]->(:Recommendation {created: 507, rating: 4, recommendationId: '6'})-[:RECOMMENDS]->(a)").end().getCommand());
        //forth best rated book by contact
        commands.push(db.cypher().match("(a:Page {pageId: '4'}), (b:User {userId: '4'})")
            .create("(b)-[:RECOMMENDS]->(:Recommendation {created: 507, rating: 3, recommendationId: '7'})-[:RECOMMENDS]->(a)").end().getCommand());
        //Book only rated by no contacts
        commands.push(db.cypher().match("(a:Page {pageId: '3'}), (b:User {userId: '4'})")
            .create("(b)-[:RECOMMENDS]->(:Recommendation {created: 508, rating: 5, recommendationId: '8'})-[:RECOMMENDS]->(a)").end().getCommand());
        ...
        return db.cypher().create("(:Page {title: 'page2Title', label: 'Youtube', description: 'page2', modified: 5080, pageId: '5'})")
            .end().send(commands).then(function () {
                return requestHandler.login(users.validUser).then(function (agent) {
                    requestAgent = agent;
                    return requestHandler.getWithData('/api/page/popularPages', {
