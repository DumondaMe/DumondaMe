...
describe('Integration Tests for contacting privacy settings', function () {
    ...
    it('Getting the contacting information for the user with the correct visibility - Return 200', function () {
        return requestHandler.login(users.validUser).then(function (agent) {
            ...
            res.body.contactingUsers[0].profileUrl.should.equal("profileImage/default/thumbnail.jpg");
            ...
            res.body.contactingUsers[1].profileUrl.should.equal("profileImage/default/thumbnail.jpg");
