...
describe('Integration Tests for searching pages administrated by the user', function () {
    ...
    it('Searching pages administrated by user- Return 200', function () {
        ...
        commands.push(db.cypher().create("(:Page {title: 'title', label:'Youtube', description: 'page2', modified: 5080, pageId: '3'})").end().getCommand());
        ...
        commands.push(db.cypher().match("(a:Page {pageId: '2'}), (b:User {userId: '1'})")
            .create("(b)-[:IS_ADMIN]->(a)").end().getCommand());
        commands.push(db.cypher().match("(a:Page {pageId: '3'}), (b:User {userId: '1'})")
            .create("(b)-[:IS_ADMIN]->(a)").end().getCommand());

        //Not returned Pages because user has not recommended pages
        commands.push(db.cypher().create("(:Page {title: 'page3Title', label:'Book', description: 'page3', modified: 5070, pageId: '4'})").end().getCommand());
        commands.push(db.cypher().create("(:Page {title: 'page4Title', label:'Youtube', description: 'page4', modified: 5080, pageId: '5'})").end().getCommand());
    ...
    it('Search single youtube recommendations of user- Return 200', function () {
        ...
        commands.push(db.cypher().create("(:Page {title: 'page1Title', label: 'Book', language: 'de', description: 'page1', modified: 5070, pageId: '0'})").end().getCommand());
        commands.push(db.cypher().create("(:Page {title: 'page3Title', label: 'Youtube', link: 'www.youtube.com', subCategory: 'Youtube', language: 'de', description: 'page2', modified: 5080, pageId: '2'})").end().getCommand());
