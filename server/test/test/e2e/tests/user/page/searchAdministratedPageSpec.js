...
describe('Integration Tests for searching pages administrated by the user', function () {
    ...
    it('Searching pages administrated by user- Return 200', function () {
        ...
        commands.push(db.cypher().create("(:BookPage {title: 'page1Title', description: 'page1', modified: 5090, pageId: '0'})").end().getCommand());
        commands.push(db.cypher().create("(:BookPage {title: 'page2Title', description: 'page2', modified: 5091, pageId: '1'})").end().getCommand());
        commands.push(db.cypher().create("(:VideoPage {title: 'page2Title', description: 'page2', modified: 5080, pageId: '2'})").end().getCommand());
        commands.push(db.cypher().create("(:VideoPage {title: 'title', description: 'page2', modified: 5080, pageId: '3'})").end().getCommand());
        ...
        commands.push(db.cypher().create("(:BookPage {title: 'page3Title', description: 'page3', modified: 5070, pageId: '4'})").end().getCommand());
        commands.push(db.cypher().create("(:VideoPage {title: 'page4Title', description: 'page4', modified: 5080, pageId: '5'})").end().getCommand());
        commands.push(db.cypher().match("(a:BookPage {pageId: '4'}), (b:User {userId: '2'})")
            .create("(b)-[:IS_ADMIN]->(a)").end().getCommand());
        commands.push(db.cypher().match("(a:VideoPage {pageId: '5'}), (b:User {userId: '2'})")
            .create("(b)-[:IS_ADMIN]->(a)").end().getCommand());
    ...
    it('Search single video recommendations of user- Return 200', function () {
