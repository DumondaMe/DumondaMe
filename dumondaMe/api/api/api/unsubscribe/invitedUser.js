...
const unsubscribe = requireModel('unsubscribe/invitedUser');

const schemaUnsubscribeInvitedUser = {
    name: 'UnsubscribeInvitedUser',
    type: 'object',
...
module.exports = function (router) {
    ...
    router.post('/', apiLimiter, asyncMiddleware(async (req, res) => {
        let request = await validation.validateRequest(req, schemaUnsubscribeInvitedUser);
        logger.info(`Unsubscribe invited user ${request.email}`, req);
