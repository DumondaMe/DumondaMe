...
describe('Get activity feed with up voted commitment answers for a user', function () {
    ...
    beforeEach(async function () {
        ...
        dbDsl.createCommitment('100', {
            ...
            website: 'https://www.example.org/', regions: ['region-1', 'region-2-1-1']
        });
        ...
        dbDsl.createCommitmentAnswer('7', {
            creatorId: '4', questionId: '1', commitmentId: '101', created: 601, description: 'commitmentDescription'
        });
    });
    ...
    it('Get by user up voted commitment answer', async function () {
    ...
    it('Get by logged in user up voted commitment answer', async function () {
