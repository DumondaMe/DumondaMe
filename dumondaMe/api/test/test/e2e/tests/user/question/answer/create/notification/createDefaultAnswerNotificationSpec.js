...
describe('Notification when user creates default answer for a question', function () {
    ...
    it('Create notification for creator of question and user watching question', async function () {
        ...
        notification[1].answer.answer.should.equals('answer');
        ...
        notification[2].answer.answer.should.equals('answer');
    ...
    it('Create a notification only once when User created the question and lists the creator of the answer in the Trust Cirlce.', async function () {
        sandbox.stub(rp, 'get');
    ...
    it('Create no notification when default answer has been created by creator of question', async function () {
        await dbDsl.sendToDb();
