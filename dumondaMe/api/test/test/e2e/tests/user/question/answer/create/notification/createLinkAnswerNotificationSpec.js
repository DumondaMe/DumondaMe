...
describe('Notification when user creates link answer for a question', function () {
    ...
    it('Create notification for creator of question and user watching question', async function () {
        ...
        notification[1].answer.title.should.equals('titleLink');
        ...
        notification[2].answer.title.should.equals('titleLink');
