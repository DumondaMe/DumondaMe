...
describe('Show the user profile in the activity feed for created books only if the privacy setting allows this', function () {
    ...
    it('Do not show logged in user when privacy setting are set to publicEl', async function () {
    ...
    it('Do not show logged in user when privacy setting are set to onlyContact', async function () {
        dbDsl.createBookAnswer('7', {
            creatorId: '1', questionId: '1', created: 999, authors: 'Hans Wurst', googleBookId: '1234',
            hasPreviewImage: true
        });
