...
describe('Show the user profile in the activity feed for up voted links only if the privacy setting allows this', function () {
    ...
    beforeEach(async function () {
        ...
        dbDsl.createLinkAnswer('6', {
            creatorId: '2', questionId: '1', created: 601, pageType: 'article', hasPreviewImage: true,
