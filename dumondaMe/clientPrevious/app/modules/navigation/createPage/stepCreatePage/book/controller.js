...
module.exports = ['StepperDialogCommandHandler', 'BookPageCreateMessageService', 'UploadPageService', 'errorToast', 'ElyModal', '$state',
    function (StepperDialogCommandHandler, BookPageCreateMessageService, UploadPageService, errorToast, ElyModal, $state) {
        var ctrl = this;
        ...
        ctrl.showExistingBooks = function (searchResult) {
