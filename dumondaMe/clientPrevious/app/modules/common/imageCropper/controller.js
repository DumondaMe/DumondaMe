...
module.exports = ['$element', 'FileReaderUtil', function ($element, FileReaderUtil) {
    var ctrl = this;
    ...
    ctrl.commands.rotate90DegreeRight = function () {
        $image.cropper('rotate', 90);
    };

    ctrl.commands.rotate90DegreeLeft = function () {
        $image.cropper('rotate', -90);
    };
