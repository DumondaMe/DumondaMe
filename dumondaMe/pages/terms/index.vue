<template>
    <div id="terms">
        <div v-if="selectedLanguage === 'de'">
            ...
            <p>1.2 Der Dienst wird unentgeltlich angeboten. Die Finanzierung von DumondaMe basiert ausschliesslich auf
                Spenden.</p>

            <h2>2. Nutzungsvoraussetzungen</h2>
            <p>2.1 Der Nutzer sichert zu, dass alle von ihm angegebenen Daten wahr sind.</p>
            <p>2.2 DumondaMe kann technisch nicht mit Sicherheit feststellen, ob ein auf DumondaMe registrierter Nutzer
                tatsächlich
                diejenige Person darstellt, die der Nutzer vorgibt zu sein. DumondaMe leistet daher keine Gewähr für die
                tatsächliche Identität eines Nutzers.
            </p>
            <p>2.3 Für den Erwerb einer DumondaMe-Mitgliedschaft ist eine Registrierung erforderlich, bei der der Nutzer
                unter
                anderem
            ...
            <p>(b) jede Handlung, die geeignet ist, die Funktionalität der DumondaMe-Infrastruktur zu beeinträchtigen,
                insbesondere
                diese übermässig zu belasten.
            </p>
            <p>3.3 DumondaMe ist nicht verpflichtet, vom Nutzer bereitgestellte Daten und/oder Informationen anderen
                Nutzern
                zur
                Verfügung zu stellen, wenn diese Daten und/oder Informationen nicht im Einklang mit den Ziffern 3.1 und
                3.2
                stehen. DumondaMe ist berechtigt,
                nach den Ziffern 3.1 und 3.2 unzulässige Daten und/oder Informationen ohne Vorankündigung gegenüber dem
                Nutzer von der DumondaMe-Websites zu
                entfernen.
            </p>

            <h2>4. Änderung der Leistungen sowie der AGB</h2>
            <p>4.1 DumondaMe behält sich vor, die auf der DumondaMe-Website angebotenen Dienste jederzeit zu ändern.</p>
            <p>4.2 DumondaMe behält sich vor, diese AGB jederzeit ohne Nennung von Gründen zu ändern. DumondaMe wird den
                Nutzer
                über
            ...
            <p>4.3 DumondaMe behält sich darüber hinaus vor, AGB zu ändern,</p>
            ...
            <p>(c) soweit DumondaMe verpflichtet ist, die Übereinstimmung der AGB mit anwendbarem Recht herzustellen,
                insbesondere wenn
            ...
            <p>5.2 Ein wichtiger Grund zur ausserordentlichen Kündigung liegt vor, wenn die Fortsetzung des
                ...
                sind für DumondaMe insbesondere die folgenden Ereignisse:
            </p>
            <ul>
            ...
            <ul>
                ...
                <li>Sperrung des Zugangs zum Dienst der DumondaMe-Website.</li>
            ...
            <p>6.2 DumondaMe bietet dem Nutzer lediglich eine Plattform an und beteiligt sich grundsätzlich nicht
                inhaltlich an
                der
            ...
            <p>6.4 Der Nutzer erkennt an, dass eine 100%ige Verfügbarkeit der DumondaMe-Website technisch nicht zu
                ...
                können zu Störungen oder zur vorübergehenden Einstellung des Dienstes auf der DumondaMe-Website führen.
            </p>
        ...
        <div v-else-if="selectedLanguage === 'en'">
            ...
            <div class="terms-text"><b>DumondaMe</b> refers to the service shown below.</div>

            <h2>1. Basics of using DumondaMe</h2>
            ...
            <p>2.4 The user is obliged to keep the password chosen by him secret. DumondaMe will not disclose the
                ...
                the DumondaMe member account (e-mail and password) is the sole responsibility of the user.
            </p>
            ...
            <p>4.1 DumondaMe reserves the right to change the services offered on the DumondaMe website at any time.</p>
            <p>4.2 DumondaMe reserves the right to change these terms and conditions at any time without giving reasons.
            ...
            <p>5.2 An important reason for extraordinary termination exists if the continuation of the contractual
                ...
                the interests of both parties. Important reasons for DumondaMe are the following events in particular:
            </p>
            <ul>
            ...
            <p>5.3 In the event of an important reason according to section 5.2, DumondaMe may impose the following
            ...
            <ul>
                ...
                <li>Blocking access to the service of the DumondaMe website.</li>
