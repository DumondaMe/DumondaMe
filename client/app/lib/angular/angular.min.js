...
(function (M, Y, t) {
    ...
    function qa(b, a) {
        if (x(b)) {
            ...
            for (c in a = a || {}, b)if ("$" !== c.charAt(0) || "$" !== c.charAt(1)) {
                a[c] =
                    b[c];
            }
        }
    ...
    function Id(b, a) {
        var c, d, e = rb.length;
        b = B(b);
        for (d = 0; d < e; ++d)if (c = rb[d] + a, F(c = b.attr(c))) {
            return c;
        }
        return null
    }
    ...
    function Db(b, a, c) {
        ...
        for (a = x(a) ? a : [a]; b;) {
            for (var d = 0, e = a.length; d < e; d++)if ((c = B.data(b, a[d])) !== t) {
                return c;
            }
    ...
    function pf(b, a, c, d) {
        ...
        m.cookies = function (a, b) {
            var d, e, f, g;
            if (a) {
                b === t ? p.cookie = encodeURIComponent(a) + "=;path=" + ca + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : F(b) && (d = (p.cookie = encodeURIComponent(a) + "=" + encodeURIComponent(b) +
            ...
            function b(b, d) {
                ...
                return a[b] = {
                    put: function (a, b) {
                        ...
                        if (!D(b)) {
                            return a in l || g++, l[a] = b, g > k && this.remove(q.key),
                                b
                        }
                    }, get: function (a) {
                        if (k < Number.MAX_VALUE) {
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, c, r, O, n, v, w, L, J, A) {
            ...
            function D(b) {
                if (d.hasOwnProperty(b)) {
                    for (var c = a.get(b + "Directive"), e = 0, f = c.length; e < f; e++)if (b = c[e], b.multiElement) {
                        return !0;
                    }
                }
                return !1
            ...
            function V(a, b, c) {
                ...
                if (a) {
                    for (g = 0, h = a.length; g < h; g++)if (a[g] == d) {
                        a[g++] = c;
                        h = g + e - 1;
        ...
        this.$get = ["$parse", "$exceptionHandler", "$sce",
            function (c, d, e) {
                ...
                function g(f, g, u, r) {
                    ...
                    r = !!r;
                    for (var v, w, L = 0, J = [], A = [], P = f.length, E = [], s = []; L < P;)if (-1 != (v = f.indexOf(b, L)) && -1 != (w = f.indexOf(a, v + h))) {
                        L !== v && E.push(O(f.substring(L,
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", "$window", function (c, d, e, f, g) {
            ...
            f.on("click", function (b) {
                if (a.rewriteLinks && !b.ctrlKey && !b.metaKey &&
                    2 != b.which) {
                    for (var e = B(b.target); "a" !== ua(e[0]);)if (e[0] === f[0] || !(e = e.parent())[0]) {
                        return;
                    }
            ...
            return {
                trustAs: function (a, b) {
                    ...
                    if (c === ma.RESOURCE_URL) {
                        ...
                        if (u) {
                            for (p = 0, q = a.length; p < q; p++)if (d(a[p], g)) {
                                u = !1;
                                break
                            }
                        }
    ...
    function Ia(b, a, c, d, e) {
        ...
        switch (f) {
            case "object":
                var h;
                if (d) {
                    for (h in b)if ("$" !== h.charAt(0) && Ia(b[h], a, c, !0)) {
                        return !0;
                    }
                    return e ? !1 : Ia(b, a, c, !1)
                }
                if ("object" === g) {
                    for (h in a)if (e = a[h], !G(e) && (f = "$" === h, !Ia(f ? b : b[h], e, c, f, f))) {
                        return !1;
                    }
                    return !0
                }
    ...
    function ic(b, a) {
        ...
        return ["$animate", function (c) {
            function d(a, b) {
                var c = [], d = 0;
                a:for (; d < a.length; d++) {
                    for (var e = a[d], m = 0; m < b.length; m++)if (e == b[m]) {
                        continue a;
                    }
                    c.push(e)
                }
    ...
    gc.prototype = {
        constructor: gc, lex: function (a) {
            this.text = a;
            this.index = 0;
            for (this.tokens = []; this.index < this.text.length;)if (a = this.text.charAt(this.index), '"' === a || "'" === a) {
                this.readString(a);
    ...
    var yd = function (a) {
        ...
        Zf = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, $f = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, zd = /^(\d{4})-(\d{2})-(\d{2})$/, Ad = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, jc = /^(\d{4})-W(\d\d)$/, Bd = /^(\d{4})-(\d\d)$/, Cd = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, ag = /(\s+|^)default(\s+|$)/, Mb = new T("ngModel"), Dd = {
            ...
            this.$$parseAndValidate = function () {
                ...
                if (d) {
                    for (var e = 0; e < n.$parsers.length; e++)if (c = n.$parsers[e](c), D(c)) {
                        d = !1;
                        break
                    }
                }
                ...
                compile: function (f, g) {
                    ...
                    return function (a, f, g, k, m) {
                        ...
                        a.$watchCollection(p, function (g) {
                            ...
                            C = J.length;
                            H = Array(C);
                            for (k = 0; k < C; k++)if (S = g === J ? k : J[k], N = g[S], G = p(S, N, k), u[G]) {
