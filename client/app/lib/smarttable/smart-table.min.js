    ...
    t.module("smart-table", []).run(["$templateCache", function (t) {
        ...
        return {
            restrict: "A", require: "^stTable", link: function (s, n, r, i) {
                function c() {
                    u++, u % 3 === 0 && r.stSkipNatural === e ? (u = 0, i.tableState().sort = {}, i.tableState().pagination.start = 0, i.pipe()) : i.sortBy(l, u % 2 === 0)
                }

                var l = r.stSort, o = a(l), u = 0, p = r.stClassAscent || "st-sort-ascent", g = r.stClassDescent || "st-sort-descent", f = [p, g];
                t.isFunction(o(s)) && (l = o(s)), n.bind("click", function () {
                    l && s.$apply(c)
                }), r.stSortDefault !== e && (u = "reverse" === r.stSortDefault ? 1 : 0, c()), s.$watch(function () {
                    return i.tableState().sort
                }, function (t) {
                    t.predicate !== l ? (u = 0, n.removeClass(p).removeClass(g)) : (u = t.reverse === !0 ? 2 : 1, n.removeClass(f[u % 2]).addClass(f[u - 1]))
                }, !0)
            }
        }
        ...
        return {
            restrict: "EA",
            require: "^stTable",
            scope: {itemsByPage: "=?", displayedPages: "=?"},
            ...
            link: function (t, e, a, s) {
                function n() {
                    ...
                    for (t.currentPage = Math.floor(n.start / n.number) + 1, r = Math.max(r, t.currentPage - Math.abs(Math.floor(t.displayedPages / 2))), e = r + t.displayedPages, e > n.numberOfPages && (e = n.numberOfPages + 1, r = Math.max(1, e - t.displayedPages)), t.pages = [], t.numPages = n.numberOfPages, a = r; e > a; a++)t.pages.push(a)
                }

                t.itemsByPage = t.itemsByPage ? +t.itemsByPage : 10, t.displayedPages = t.displayedPages ? +t.displayedPages : 5, t.currentPage = 1, t.pages = [], t.$watch(function () {
                    return s.tableState().pagination
                }, n, !0), t.$watch("stItemsByPage", function () {
                    t.selectPage(1)
                }), t.$watch("stDisplayedPages", n), t.selectPage = function (e) {
                    e > 0 && e <= t.numPages && s.slice((e - 1) * t.itemsByPage, t.itemsByPage)
                }, s.slice(0, t.itemsByPage)
            }
        }
