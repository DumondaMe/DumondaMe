...
describe('Integration Tests for getting discussion ideas overview', function () {
    ...
    it('Getting discussion ideas overview', function () {
        ...
        return dbDsl.sendToDb().then(function () {
            ...
            res.body.feedbacks[0].title.should.equals('discussionIdea4Title');
            res.body.feedbacks[0].description.should.equals('discussionIdea4Description');
            res.body.feedbacks[0].created.should.equals(501);
            ...
            res.body.feedbacks[1].title.should.equals('discussionIdea6Title');
            res.body.feedbacks[1].description.should.equals('discussionIdea6Description');
            res.body.feedbacks[1].created.should.equals(503);
            res.body.feedbacks[1].feedbackId.should.equals('6');
            ...
            res.body.feedbacks[2].title.should.equals('discussionIdea5Title');
            res.body.feedbacks[2].description.should.equals('discussionIdea5Description');
            res.body.feedbacks[2].created.should.equals(502);
            res.body.feedbacks[2].feedbackId.should.equals('5');
