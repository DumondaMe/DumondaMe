...
describe('Integration Tests for getting ideas overview', function () {
    ...
    it('No open ideas for overview', function () {
        ...
        dbDsl.createFeedbackIdea('5', '1', 504, 'closed');
    ...
    it('Getting open idea overview', function () {
        ...
        dbDsl.createFeedbackIdea('4', '4', 503, 'closed');
        ...
        return dbDsl.sendToDb().then(function () {
            ...
            res.body.feedbacks[0].title.should.equals('idea1Title');
            res.body.feedbacks[0].description.should.equals('idea1Description');
            ...
            res.body.feedbacks[1].title.should.equals('idea3Title');
            res.body.feedbacks[1].description.should.equals('idea3Description');
            ...
            res.body.feedbacks[2].title.should.equals('idea2Title');
            res.body.feedbacks[2].description.should.equals('idea2Description');
