...
describe('Integration Tests for deleting a youtube page', function () {
    ...
    beforeEach(function () {
        ...
        return dbDsl.init(2).then(function () {
            ...
            dbDsl.createYoutubePage('2', {
                adminId: '2', language: ['de'], topic: ['health', 'personalDevelopment'], created: 5091, link: 'https://www.youtube.com/watch?v=hTarMdJub0M',
                linkEmbed: 'https://www.youtube.com/embed/hTarMdJub0M'
            });
    ...
    it('Delete Successfully a youtube page', function () {
    ...
    it('Delete a youtube page failed because recommendation of other user exists - Return 400', function () {
    ...
    it('Delete a youtube page failed because user is not admin of page - Return 400', function () {
