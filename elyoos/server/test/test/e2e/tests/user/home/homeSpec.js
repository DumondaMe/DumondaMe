...
describe('Integration Tests for getting home screen information for a user', function () {
    ...
    it('Getting user blogs, contact blogs and recommendations', function () {
        ...
        dbDsl.createBlog('3', {blogWriterUserId: '2', language: ['en'], topic: ['health', 'personalDevelopment'], created: 500, visible: ['Freund'], pictureHeight: 400});
        dbDsl.createBlog('4', {blogWriterUserId: '2', language: ['en'], topic: ['health', 'personalDevelopment'], created: 501, visible: ['Freund']});
        ...
        return dbDsl.sendToDb().then(function () {
            ...
            res.body.pinwall[1].title.should.equals('page0Title');
            res.body.pinwall[1].created.should.equals(502);
            res.body.pinwall[1].profileUrl.should.equals('profileImage/2/thumbnail.jpg');
            res.body.pinwall[1].previewUrl.should.equals('pages/0/pagePreview.jpg');
            res.body.pinwall[1].description.should.equals('page0Description');
            ...
            res.body.pinwall[2].created.should.equals(501);
            res.body.pinwall[2].profileUrl.should.equals('profileImage/2/thumbnail.jpg');
            should.not.exist(res.body.pinwall[2].previewUrl);
            should.not.exist(res.body.pinwall[2].urlFull);
            ...
            res.body.pinwall[2].isPublic.should.equals(false);
            ...
            res.body.pinwall[3].pinwallType.should.equals('Blog');
            ...
            res.body.pinwall[3].created.should.equals(500);
            res.body.pinwall[3].profileUrl.should.equals('profileImage/2/thumbnail.jpg');
            res.body.pinwall[3].previewUrl.should.equals('blog/3/preview.jpg');
            res.body.pinwall[3].title.should.equals('blog3Title');
            res.body.pinwall[3].text.should.equals('blog3Text');
            ...
            res.body.pinwall[4].link.should.equals('www.host.com/test');
            res.body.pinwall[4].hostname.should.equals('www.host.com');
            res.body.pinwall[4].userId.should.equals('2');
            res.body.pinwall[4].title.should.equals('page2Title');
            res.body.pinwall[4].created.should.equals(499);
            res.body.pinwall[4].profileUrl.should.equals('profileImage/2/thumbnail.jpg');
            res.body.pinwall[4].previewUrl.should.equals('pages/2/preview.jpg');
            res.body.pinwall[4].heightPreviewImage.should.equals(200);
            res.body.pinwall[4].description.should.equals('page2Description');
            ...
            res.body.pinwall[5].title.should.equals('generic8Title');
            res.body.pinwall[5].created.should.equals(498);
            res.body.pinwall[5].previewUrl.should.equals('pages/8/preview.jpg');
            res.body.pinwall[5].profileUrl.should.equals('profileImage/2/thumbnail.jpg');
            res.body.pinwall[5].description.should.equals('page8Description');
    ...
    it('Getting user blogs, contact blogs and recommendations (show not only contacts)', function () {
        ...
        return dbDsl.sendToDb().then(function () {
            ...
            should.not.exist(res.body.pinwall[0].previewUrl);
            res.body.pinwall[0].title.should.equals('blog5Title');
            res.body.pinwall[0].text.should.equals('blog5Text');
            ...
            res.body.pinwall[1].link.should.equals('https://www.youtube.com/watch?v=hTarMdJub0M');
            ...
            res.body.pinwall[2].forename.should.equals('user');
            res.body.pinwall[2].userId.should.equals('2');
            res.body.pinwall[2].title.should.equals('page0Title');
            res.body.pinwall[2].created.should.equals(502);
            res.body.pinwall[2].profileUrl.should.equals('profileImage/2/thumbnail.jpg');
            res.body.pinwall[2].previewUrl.should.equals('pages/0/pagePreview.jpg');
            res.body.pinwall[2].description.should.equals('page0Description');
            ...
            res.body.pinwall[3].pinwallType.should.equals('Blog');
            res.body.pinwall[3].pageId.should.equals('4');
            res.body.pinwall[3].name.should.equals('user Meier2');
            res.body.pinwall[3].forename.should.equals('user');
            res.body.pinwall[3].userId.should.equals('2');
            res.body.pinwall[3].created.should.equals(501);
            res.body.pinwall[3].profileUrl.should.equals('profileImage/2/thumbnail.jpg');
            should.not.exist(res.body.pinwall[3].previewUrl);
            should.not.exist(res.body.pinwall[3].urlFull);
            res.body.pinwall[3].title.should.equals('blog4Title');
            res.body.pinwall[3].text.should.equals('blog4Text');
            res.body.pinwall[3].isAdmin.should.equals(false);
            res.body.pinwall[3].isPublic.should.equals(false);
            res.body.pinwall[3].topic.length.should.equals(2);
            res.body.pinwall[3].topic[0].should.equals('health');
            ...
            res.body.pinwall[4].forename.should.equals('user');
            res.body.pinwall[4].userId.should.equals('2');
            res.body.pinwall[4].created.should.equals(500);
            res.body.pinwall[4].profileUrl.should.equals('profileImage/2/thumbnail.jpg');
            res.body.pinwall[4].previewUrl.should.equals('blog/3/preview.jpg');
            res.body.pinwall[4].title.should.equals('blog3Title');
            res.body.pinwall[4].text.should.equals('blog3Text');
            ...
            res.body.pinwall[5].pageId.should.equals('2');
            res.body.pinwall[5].name.should.equals('user Meier2');
            res.body.pinwall[5].forename.should.equals('user');
            res.body.pinwall[5].link.should.equals('www.host.com/test');
            res.body.pinwall[5].hostname.should.equals('www.host.com');
            res.body.pinwall[5].userId.should.equals('2');
            res.body.pinwall[5].title.should.equals('page2Title');
            res.body.pinwall[5].created.should.equals(499);
            res.body.pinwall[5].profileUrl.should.equals('profileImage/2/thumbnail.jpg');
            res.body.pinwall[5].previewUrl.should.equals('pages/2/preview.jpg');
            res.body.pinwall[5].heightPreviewImage.should.equals(200);
            res.body.pinwall[5].description.should.equals('page2Description');
            res.body.pinwall[5].recommendedByUser.should.equals(false);
            res.body.pinwall[5].thisRecommendationByUser.should.equals(false);
            res.body.pinwall[5].totalNumberOfRecommendations.should.equals(1);
            res.body.pinwall[5].topic.length.should.equals(2);
            ...
            res.body.pinwall[6].label.should.equals('Generic');
            res.body.pinwall[6].pageId.should.equals('8');
            ...
            res.body.pinwall[6].title.should.equals('generic8Title');
            res.body.pinwall[6].created.should.equals(498);
            res.body.pinwall[6].previewUrl.should.equals('pages/8/preview.jpg');
            res.body.pinwall[6].profileUrl.should.equals('profileImage/2/thumbnail.jpg');
            res.body.pinwall[6].description.should.equals('page8Description');
