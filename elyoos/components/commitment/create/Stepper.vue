<template>
    <stepper-header>
        <step :name="$t('pages:commitment.createDialog.stepWebsite')" :number="1" :selected-step="selectedStep">
        </step>
        <v-divider></v-divider>
        ...
        <v-divider></v-divider>
        <step :name="$t('pages:commitment.createDialog.stepKeyTerms')" :number="4" :selected-step="selectedStep">
        </step>
    </stepper-header>
</template>
