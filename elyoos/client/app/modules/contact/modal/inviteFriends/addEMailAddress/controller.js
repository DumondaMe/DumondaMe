...
module.exports = ['CheckEmailAddresses', 'EmailAddressParser', function (CheckEmailAddresses, EmailAddressParser) {
    var ctrl = this;
    ctrl.emailAddressIsInvalid = true;
    ctrl.selectedAddresses = [];

    ctrl.emailChanged = function () {
        ctrl.emailAddressIsInvalid = !CheckEmailAddresses.checkAddresses(ctrl.newEmailAddresses);
    ...
    ctrl.addEmailAddressesCommand = function () {
        ctrl.addEmailAddresses();
    };
