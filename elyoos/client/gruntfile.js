...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        ngconstant: {
            ...
            preview: {
                constants: {
                    OAUTH_GMAIL_URL: 'https://accounts.google.com/o/oauth2/auth?response_type=code&client_id=270929621236-4cauqnck95vm8ohkvu3rokhp74jued28.apps.googleusercontent.com&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fcontacts.readonly&redirect_uri=http%3A%2F%2Fpreview.elyoos.org%2Fauth',
                    ...
                    OAUTH_OUTLOOK_URL: 'https://login.microsoftonline.com/common/oauth2/v2.0/authorize?response_type=code&client_id=dd12544c-d6e4-4d3d-92b8-7b42941284e9&scope=openid%20https://outlook.office.com/contacts.read&redirect_uri=http%3A%2F%2Fpreview.elyoos.org%2Fauth'
                }
            },
            production: {
                constants: {
                    OAUTH_GMAIL_URL: 'https://accounts.google.com/o/oauth2/auth?response_type=code&client_id=270929621236-4cauqnck95vm8ohkvu3rokhp74jued28.apps.googleusercontent.com&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fcontacts.readonly&redirect_uri=http%3A%2F%2Fwww.elyoos.org%2Fauth',
                    ...
                    OAUTH_OUTLOOK_URL: 'https://login.microsoftonline.com/common/oauth2/v2.0/authorize?response_type=code&client_id=4604a845-acf0-4770-9a2c-6b0e19943b94&scope=openid%20https://outlook.office.com/contacts.read&redirect_uri=http%3A%2F%2Fwww.elyoos.org%2Fauth'
                }
            }
        },
        sonarRunner: {
    ...
    grunt.registerTask('buildPreview', ['ngtemplates', 'ngconstant:preview', 'browserify']);
    grunt.registerTask('buildProduction', ['ngtemplates', 'ngconstant:production', 'browserify']);
};
