...
let createBookPage = requireModel('user/page/create/bookPage');
let createVideoPage = requireModel('user/page/create/videoPage');
let createLinkPage = requireModel('user/page/create/linkPage');
let createGenericPage = requireModel('user/page/create/genericPage');
