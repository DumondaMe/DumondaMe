...
describe('Get answers created by the requested user', function () {
    ...
    beforeEach(async function () {
        ...
        dbDsl.createBookAnswer('11', {
            creatorId: '1', questionId: '100', created: 444, authors: 'Hans Wurst', googleBookId: '1234',
            hasPreviewImage: true
        });
    });
    ...
    it('Get answers the logged in user has created', async function () {
        ...
        let res = await requestHandler.get('/api/user/profile/answer', {
            userId: '1', maxItems: 5, skip: 1, upVoted: false, language: 'de'
        });
    ...
    it('Get answers a user has created (public, visible)', async function () {
    ...
    it('Get answers a user has created  (publicEl, visible)', async function () {
        ...
        await requestHandler.login(users.validUser2);
        let res = await requestHandler.get('/api/user/profile/answer', {
            userId: '1', maxItems: 2, skip: 1, upVoted: false, language: 'de'
        });
        res.status.should.equal(200);
        res.body.numberOfAnswers.should.equal(7);
    ...
    it('Get answers a user has created  (publicEl, invisible)', async function () {
    ...
    it('Get answers a user has created  (onlyContact, visible)', async function () {
    ...
    it('Get answers a user has created  (onlyContact, invisible)', async function () {
