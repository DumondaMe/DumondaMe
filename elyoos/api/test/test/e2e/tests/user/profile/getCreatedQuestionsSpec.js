...
describe('Get questions created by the requested user', function () {
    ...
    beforeEach(async function () {
        ...
        dbDsl.createQuestion('101', {
            creatorId: '1', question: 'Das ist eine Frage2', description: 'Test elyoos.org change the world2',
        ...
        dbDsl.createQuestion('102', {
            creatorId: '1', question: 'Das ist eine Frage3',
            topics: ['Spiritual'], language: 'de', created: 664
        });

        dbDsl.createQuestion('103', {
            creatorId: '1', question: 'Das ist eine Frage4', description: 'Test elyoos.org change the world4',
            topics: ['Spiritual'], language: 'de', created: 663
        });

        dbDsl.createQuestion('104', {
            creatorId: '2', question: 'Das ist eine Frage5', description: 'Test elyoos.org change the world5',
    ...
    it('Get questions the logged in user has created', async function () {
    ...
    it('Get questions a user has created (public, visible)', async function () {
    ...
    it('Get questions a user has created (publicEl, visible)', async function () {
    ...
    it('Get questions a user has created (publicEl, invisible)', async function () {
    ...
    it('Get questions a user has created (onlyContact, visible)', async function () {
    ...
    it('Get questions a user has created (onlyContact, invisible)', async function () {
