...
describe('Integration Tests for getting similar pages for a page', function () {
    ...
    it('Similar pages recommended by the contacts of the user, all cases', function () {
        ...
        dbDsl.createContactConnection('1', '12', 'Freund', 500);
        ...
        dbDsl.crateRecommendationsForPage('4', [{userId: '1', created: 500}, {userId: '3', created: 500}, {userId: '12', created: 500}]);
        ...
        dbDsl.crateRecommendationsForPage('9', [{userId: '3', created: 500}, {userId: '12', created: 500}]);
