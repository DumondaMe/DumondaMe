...
describe('Send invitations emails', function () {
    ...
    it('Sending invitation', async function () {
        ...
        }, 'de', 'info@dumonda.me', 'user3@irgendwo.ch').should.be.true;
    ...
    it('Sending multiple invitations from same user', async function () {
        ...
        }, 'de', 'info2@dumonda.me', 'user3@irgendwo.ch').should.be.true;
        ...
        }, 'en', 'info3@dumonda.me', 'user3@irgendwo.ch').should.be.true;
